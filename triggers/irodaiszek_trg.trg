...
BEGIN
  ...
  Select h.ar into v_hattamla_ar from hattamla h where h.hattamla_id = :new.hattamla_id;
  Select u.ar into v_ules_ar from ules u where u.ules_id = :new.ules_id;
  Select t.ar into v_talp_ar from talp t where t.talp_id = :new.talp_id;
  ...
  IF inserting
   THEN
    ...
    END IF;
    :new.ar := v_hattamla_ar+v_ules_ar+v_talp_ar;
